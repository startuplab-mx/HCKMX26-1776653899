...
Durante el hackathon utilizamos **Claude (Anthropic)** como asistente en el proceso de desarrollo. Nos ayudó a generar ideas para mejorar la arquitectura del sistema — como la estructura de validación de entradas, el manejo de errores estandarizado y la migración del motor de IA — y a implementar esas ideas en código. Las decisiones de arquitectura, el diseño de la API y el deploy en Railway fueron trabajo del equipo.
